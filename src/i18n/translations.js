...
export const translations = {
  tr: {
    ...
    servicePages: {
      ...
      premiumCalc: {
        eyebrow: 'Hesap makinesi',
        title: 'Paketinizi toplayın — fiyatı anında görün.',
        subtitle: 'İhtiyacınız olan premium hizmetleri seçin. Birden fazla seçim aynı anda — paket indirimi otomatik uygulanır.',
        fromLabel: 'Başlangıç',
        groups: {
          brand: 'Branding ve kreatif',
          product: 'Web ve dijital ürün',
        },
        items: {
          logo: { title: 'Logo tasarımı', desc: 'Marka için ana logo + alt versiyonlar.' },
          identity: { title: 'Kurumsal kimlik', desc: 'Renk, tipografi, ikonografi ve şablonlar.' },
          visualConcept: { title: 'Görsel konsept', desc: 'Marka için tutarlı görsel dil.' },
          adCampaign: { title: 'Yaratıcı reklam kampanyası', desc: 'Reklam serisi için fikir, görsel ve metin.' },
          packaging: { title: 'Marka paketleme', desc: 'Pazara hazır marka kiti.' },
          website: { title: 'Web sitesi / landing', desc: 'Stratejiden tasarıma ve geliştirmeye.' },
          uxui: { title: 'UX/UI tasarım', desc: 'Ürün arayüzleri için araştırma + tasarım.' },
          cro: { title: 'Dönüşüm optimizasyonu', desc: 'Test, analiz, hipotez döngüsü.' },
          support: { title: 'Teknik destek', desc: 'Site bakımı ve hızlı düzenlemeler.' },
        },
        summary: {
          eyebrow: 'Tahmini paket',
          empty: 'Henüz hizmet seçilmedi',
          selected: '{count} hizmet seçildi',
          discount: 'paket indirimi {percent}%',
          note: 'Fiyatlar yön gösterici «başlangıç» rakamlarıdır. Nihai teklifi brief sonrası gönderiyoruz.',
        },
        cta: 'Brief gönder',
      },
    },
    ...
    educationPage: {
      ...
      detail: {
        ...
        comingSoonEyebrow: 'Yakında',
        comingSoonTitle: 'Bu program henüz hazırlık aşamasında.',
        comingSoonDesc: 'Kontenjan açıldığında en önce siz bilgi alın — bekleme listesine ekleyelim.',
        comingSoonCta: 'Beni haberdar et',
        comingSoonGreeting: 'Merhaba! «{program}» programının açılış tarihinden haberdar olmak istiyorum.',
        ...
        topics: {
          ...
          aiVideo: {
            ...
            exam: false,
            blocks: [
              { title: 'AI video temelleri', desc: '' },
              { title: 'Senaryo ve hikâye', desc: '' },
              { title: 'Üretim ve iyileştirme', desc: '' },
              { title: 'Kurgu ve yayın', desc: '' },
            ],
          },
          graphicDesign: {
            lessonsCount: null,
    ...
    dashboard: {
      ...
      subtitle: 'Yol haritandaki dersler ve ilerlemen.',
      lessonsTitle: 'Derslerim',
      lessonsSubtitle: 'Her ders kendi ilerleme çubuğuna sahip. Tamamlamak için tikle.',
      lessonsCount: 'ders',
      lessonsDone: 'ders tamamlandı',
      cardContinue: 'Devam et',
      cardReview: 'Tekrar et',
      cardStart: 'Başla',
      cardLocked: 'Kilitli',
      cardMarkAll: 'Tümünü tikle',
      cardReset: 'Sıfırla',
    ...
    myCourses: {
      eyebrow: 'Kurslarım',
      title: 'Kayıtlı olduğun kurslar',
      subtitle: 'Buradan kurslarına devam et. İlk iki ders ücretsiz, gerisi ödeme sonrası açılır.',
      empty: 'Henüz hiçbir kursa kaydolmadın.',
      browse: 'Kurslara göz at',
      previewBadge: 'Önizleme',
      paidBadge: 'Ödendi',
      freeLessons: 'İlk 2 ders ücretsiz',
      open: 'Kursa git',
      unenroll: 'Kayıttan çık',
      unenrollConfirm: 'Bu kursu kabinden silmek istediğine emin misin?',
      pay: 'Kursu öde',
      lessonsDoneOf: '{done} / {total} ders',
      enrolledAt: 'Kayıt:',
      lockedRest: 'Kalan dersler kilitli',
    },
    course: {
      backToDashboard: 'Kabine geri dön',
      lessonsTitle: 'Kurs içeriği',
      lessonsCount: 'ders',
      previewEyebrow: 'Ücretsiz önizleme',
      previewTitle: 'İlk iki ders senin için açık',
      previewDesc: 'İçeriği değerlendir, sonra erişimi aç ve gerisini gör.',
      paidEyebrow: 'Tam erişim',
      paidTitle: 'Tüm dersler açık',
      paidDesc: 'İyi şanslar! Kursu istediğin sırada geçebilirsin.',
      free: 'Ücretsiz',
      locked: 'Kilitli',
      markDone: 'Tamamlandı',
      lessonLocked: 'Bu ders kilitli',
      lessonLockedDesc: 'Kalan dersleri açmak için kursu öde.',
      unlockCta: 'Kursu öde',
      progressTitle: 'Kurs ilerlemesi',
      block: 'Blok',
      noBlocks: 'Bu kurs için henüz içerik eklenmedi.',
    },
    payment: {
      eyebrow: 'Ödeme',
      title: 'Kursa tam erişim',
      priceLabel: 'Tutar',
      cardLabel: 'Kart numarası',
      expLabel: 'Son kullanma',
      submit: 'Ödemeyi tamamla',
      processing: 'İşleniyor…',
      cancel: 'Vazgeç',
      disclaimer: 'Demo ödeme — gerçek bir kart işleminden geçilmez.',
      defaultPrice: '4 900 ₽',
    },
    enrollment: {
      ctaEyebrow: 'Doğrudan kayıt',
      ctaTitle: 'Kursu kabinde aç',
      ctaDesc: 'Kabinine kayıt olunsun, ilk iki ders hemen açılsın. Devamını ödedikten sonra göreceksin.',
      ctaButton: 'Kaydol',
      enrolledLabel: 'Zaten kayıtlısın',
      openCabinet: 'Kabinde aç',
      needLogin: 'Devam etmek için giriş yap',
      goToLogin: 'Giriş yap',
      modal: {
        eyebrow: 'Tebrikler',
        title: 'Kursa kaydoldun',
        descNew: 'İlk iki ders kabininde açıldı. Mentorla iletişime geç — detayları birlikte ayarlayalım.',
        descExisting: 'Mentorla iletişime geç — sorularını sorabilir, programı netleştirebilirsin.',
        contactTitle: 'Mentorla iletişim',
        openCabinet: 'Kabinde aç',
        close: 'Kapat',
      },
    },
  ...
  en: {
    ...
    servicePages: {
      ...
      premiumCalc: {
        eyebrow: 'Calculator',
        title: 'Pick your scope — see the price live.',
        subtitle: 'Tick the premium services you need. Bundle discount applies automatically as you add more.',
        fromLabel: 'From',
        groups: {
          brand: 'Branding & creative',
          product: 'Web & digital product',
        },
        items: {
          logo: { title: 'Logo design', desc: 'Primary mark with sub-versions for the brand.' },
          identity: { title: 'Visual identity', desc: 'Color, type, iconography and templates.' },
          visualConcept: { title: 'Visual concept', desc: 'A coherent visual language for the brand.' },
          adCampaign: { title: 'Creative ad campaign', desc: 'Idea, visuals and copy for an ad series.' },
          packaging: { title: 'Brand packaging', desc: 'Market-ready brand kit.' },
          website: { title: 'Website / landing', desc: 'From strategy to design and build.' },
          uxui: { title: 'UX/UI design', desc: 'Research + design for product interfaces.' },
          cro: { title: 'Conversion optimization', desc: 'Test, analyze, iterate.' },
          support: { title: 'Tech support', desc: 'Site maintenance and quick edits.' },
        },
        summary: {
          eyebrow: 'Estimated bundle',
          empty: 'Nothing selected yet',
          selected: '{count} services selected',
          discount: '{percent}% bundle discount',
          note: 'Prices are indicative «from» numbers. Final quote is sent after the brief.',
        },
        cta: 'Send brief',
      },
    },
    ...
    educationPage: {
      ...
      detail: {
        ...
        comingSoonTitle: 'This program is still in the works.',
        comingSoonDesc: 'Want first access? Drop a line — we’ll add you to the waiting list and ping you when seats open.',
        comingSoonCta: 'Notify me',
        comingSoonGreeting: 'Hi! I’d like to be notified when «{program}» opens for enrollment.',
        programLabel: 'Program',
        formatLabel: 'Format',
        timeLabel: 'Time',
        days: {
        ...
        topics: {
          ...
          aiVideo: {
            ...
            exam: false,
            blocks: [
              { title: 'AI video fundamentals', desc: '' },
              { title: 'Story & script', desc: '' },
              { title: 'Generation & refinement', desc: '' },
              { title: 'Editing & publishing', desc: '' },
            ],
          },
          graphicDesign: {
            lessonsCount: null,
    ...
    dashboard: {
      ...
      subtitle: 'Your lessons and progress on the roadmap.',
      lessonsTitle: 'My lessons',
      lessonsSubtitle: 'Each lesson has its own progress bar. Tick lessons to complete them.',
    ...
    myCourses: {
      eyebrow: 'My courses',
      title: 'Courses you signed up for',
      subtitle: 'Pick up where you left off. The first two lessons are free, the rest unlock after payment.',
      empty: 'You have not signed up for any courses yet.',
      browse: 'Browse courses',
      previewBadge: 'Preview',
      paidBadge: 'Paid',
      freeLessons: 'First 2 lessons free',
      open: 'Open course',
      unenroll: 'Drop course',
      unenrollConfirm: 'Remove this course from your cabinet?',
      pay: 'Pay for course',
      lessonsDoneOf: '{done} / {total} lessons',
      enrolledAt: 'Enrolled:',
      lockedRest: 'The rest of the lessons are locked',
    },
    course: {
      ...
      previewTitle: 'The first two lessons are open',
      previewDesc: 'Try the course, then unlock full access to see the rest.',
      paidEyebrow: 'Full access',
      paidTitle: 'All lessons unlocked',
      paidDesc: 'Enjoy — go through the course at your own pace.',
      free: 'Free',
      locked: 'Locked',
      markDone: 'Mark done',
      lessonLocked: 'This lesson is locked',
      lessonLockedDesc: 'Pay for the course to unlock the rest of the lessons.',
      unlockCta: 'Pay for course',
      progressTitle: 'Course progress',
      block: 'Block',
      noBlocks: 'No content has been added to this course yet.',
    },
    payment: {
      eyebrow: 'Payment',
      ...
      cancel: 'Cancel',
      disclaimer: 'Demo payment — no real card is charged.',
      defaultPrice: '$49',
    },
    enrollment: {
      ctaEyebrow: 'Direct signup',
      ctaTitle: 'Open the course in your cabinet',
      ctaDesc: 'We will enroll you in your cabinet and unlock the first two lessons immediately. The rest opens after payment.',
      ctaButton: 'Sign up',
      enrolledLabel: 'You are already enrolled',
      openCabinet: 'Open in cabinet',
      needLogin: 'Log in to continue',
      goToLogin: 'Log in',
      modal: {
        eyebrow: 'You’re in',
        title: 'You’re enrolled in the course',
        descNew: 'The first two lessons are now open in your cabinet. Reach out to a mentor — we’ll line up the details together.',
        descExisting: 'Reach out to a mentor — ask questions or clarify the schedule.',
        contactTitle: 'Contact a mentor',
        openCabinet: 'Open in cabinet',
        close: 'Close',
      },
    },
  ...
  ru: {
    ...
    servicePages: {
      ...
      premiumCalc: {
        eyebrow: 'Калькулятор',
        title: 'Соберите пакет — увидите цену сразу.',
        subtitle: 'Отметьте нужные премиум-услуги. Пакетная скидка применяется автоматически — чем больше услуг, тем выгоднее.',
        fromLabel: 'от',
        groups: {
          brand: 'Брендинг и креатив',
          product: 'Сайт и цифровой продукт',
        },
        items: {
          logo: { title: 'Разработка логотипа', desc: 'Основной знак + альтернативные версии.' },
          identity: { title: 'Фирменный стиль и айдентика', desc: 'Цвет, типографика, иконы и шаблоны.' },
          visualConcept: { title: 'Визуальная концепция', desc: 'Целостный визуальный язык бренда.' },
          adCampaign: { title: 'Креативная рекламная кампания', desc: 'Идея, визуал и копирайт под серию.' },
          packaging: { title: 'Упаковка бренда', desc: 'Бренд-кит, готовый к выходу на рынок.' },
          website: { title: 'Сайт / лендинг', desc: 'От стратегии до дизайна и сборки.' },
          uxui: { title: 'UX/UI дизайн', desc: 'Исследование + дизайн интерфейсов продукта.' },
          cro: { title: 'Оптимизация конверсии', desc: 'Гипотезы, тесты и доводка по данным.' },
          support: { title: 'Техническая поддержка', desc: 'Сопровождение и оперативные правки.' },
        },
        summary: {
          eyebrow: 'Оценка пакета',
          empty: 'Услуги пока не выбраны',
          selected: 'Выбрано услуг: {count}',
          discount: 'скидка за пакет {percent}%',
          note: 'Цены ориентировочные «от». Финальное предложение присылаем после брифа.',
        },
        cta: 'Отправить бриф',
      },
    },
    ...
    educationPage: {
      ...
      detail: {
        ...
        comingSoonTitle: 'Программа ещё в разработке.',
        comingSoonDesc: 'Хотите узнать первым, когда откроем набор? Оставим вас в листе ожидания и сообщим о старте.',
        comingSoonCta: 'Сообщить мне',
        comingSoonGreeting: 'Здравствуйте! Хочу узнать о старте программы «{program}» — добавьте, пожалуйста, в лист ожидания.',
        ...
        topics: {
          ...
          aiVideo: {
            ...
            exam: false,
            blocks: [
              { title: 'Основы AI-видео', desc: '' },
              { title: 'Сценарий и история', desc: '' },
              { title: 'Генерация и доводка', desc: '' },
              { title: 'Монтаж и публикация', desc: '' },
            ],
          },
          graphicDesign: {
            lessonsCount: null,
    ...
    dashboard: {
      ...
      subtitle: 'Ваши уроки и прогресс по роадмапу.',
      lessonsTitle: 'Мои уроки',
      lessonsSubtitle: 'У каждого урока — свой прогресс-бар. Кликайте, чтобы отмечать пройденные.',
      lessonsCount: 'уроков',
      lessonsDone: 'уроков пройдено',
      cardContinue: 'Продолжить',
      cardReview: 'Повторить',
      cardStart: 'Начать',
      cardLocked: 'Закрыто',
      cardMarkAll: 'Отметить все',
      cardReset: 'Сбросить',
    ...
    myCourses: {
      eyebrow: 'Мои курсы',
      title: 'Курсы, на которые ты записан',
      subtitle: 'Возвращайся сюда, чтобы продолжить. Первые два урока бесплатно, остальные открываются после оплаты.',
      empty: 'Ты ещё не записан ни на один курс.',
      browse: 'Открыть каталог',
      previewBadge: 'Превью',
      paidBadge: 'Оплачен',
      freeLessons: 'Первые 2 урока бесплатно',
      open: 'Открыть курс',
      unenroll: 'Отписаться',
      unenrollConfirm: 'Убрать этот курс из кабинета?',
      pay: 'Оплатить курс',
      lessonsDoneOf: '{done} / {total} уроков',
      enrolledAt: 'Записан:',
      lockedRest: 'Остальные уроки закрыты',
    },
    course: {
      backToDashboard: 'Назад в кабинет',
      lessonsTitle: 'Содержание курса',
      lessonsCount: 'уроков',
      previewEyebrow: 'Бесплатное превью',
      previewTitle: 'Первые два урока уже открыты',
      previewDesc: 'Посмотри программу и оцени материал — затем открывай полный доступ.',
      paidEyebrow: 'Полный доступ',
      paidTitle: 'Все уроки открыты',
      paidDesc: 'Удачи на курсе — проходи в удобном темпе.',
      free: 'Бесплатно',
      locked: 'Закрыто',
      markDone: 'Пройдено',
      lessonLocked: 'Этот урок закрыт',
      lessonLockedDesc: 'Чтобы открыть остальные уроки, оплати курс.',
      unlockCta: 'Оплатить курс',
      progressTitle: 'Прогресс по курсу',
      block: 'Блок',
      noBlocks: 'Контент к этому курсу ещё не добавлен.',
    },
    payment: {
      eyebrow: 'Оплата',
      title: 'Полный доступ к курсу',
      priceLabel: 'Сумма',
      ...
      cancel: 'Отмена',
      disclaimer: 'Демо-оплата — реальная карта не списывается.',
      defaultPrice: '4 900 ₽',
    },
    enrollment: {
      ctaEyebrow: 'Запись напрямую',
      ctaTitle: 'Открыть курс в личном кабинете',
      ctaDesc: 'Мы запишем тебя на курс и сразу откроем первые два урока. Остальное откроется после оплаты.',
      ctaButton: 'Записаться',
      enrolledLabel: 'Ты уже записан',
      openCabinet: 'Открыть в кабинете',
      needLogin: 'Войди, чтобы продолжить',
      goToLogin: 'Войти',
      modal: {
        eyebrow: 'Поздравляем',
        title: 'Ты записан на курс',
        descNew: 'Первые два урока уже открыты в личном кабинете. Свяжись с ментором — обсудим детали и расписание.',
        descExisting: 'Свяжись с ментором — задай вопросы и уточни программу.',
        contactTitle: 'Связаться с ментором',
        openCabinet: 'Открыть в кабинете',
        close: 'Закрыть',
      },
    },
